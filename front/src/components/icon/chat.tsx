export const ChatIcon = () => {
    return <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M18.6629 12.8334H18.6733" stroke="#0060FF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M13.9949 12.8334H14.0054" stroke="#0060FF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M9.32741 12.8334H9.33789" stroke="#0060FF" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
